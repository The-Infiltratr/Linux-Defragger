...
grep -q 'Growth Defrag preflight (1.8.0-35): checking' \
...
PYTHONPATH="$ROOT/gui" "$ROOT/tests/test_ntfs_live_map.py" >/dev/null
...
PYTHONPATH="$ROOT/gui" "$ROOT/tests/test_gui_revision35.py" >/dev/null
PYTHONPATH="$ROOT/gui" "$ROOT/tests/test_plugin_architecture.py" >/dev/null
PYTHONPATH="$ROOT/gui" "$ROOT/tests/test_range_helpers.py" >/dev/null
PYTHONPATH="$ROOT/gui" "$ROOT/tests/test_core_modules.py" >/dev/null
